                                 ...
                                 <form action="{{ route('subcategory.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="category_id" id="category_id" class="form-control" required>
                                                ...
                                                @forelse ($categories as $category)
                                                  <option value="{{ $category->id }}">{{ ucwords($category->categoy_name) }}</option>
                                                @empty
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="subcategory_name" id="subcategory_name" required class="form-control" placeholder="Subcategory Name...">
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group">
                                            <label for="subcategory_image">Subcategory Image<span class="text-danger">*</span></label>
                                            <input type="file" name="subcategory_image" id="subcategory_image" required class="form-control">
                                        </div>
