                    ...
                    <div class="panel panel-bd lobidrag panel-primary">
                        ...
                        <div class="panel-body">
                            <div>
                                ...
                                <input type="text" class="form-control" value="{{ old('product_title') }}" placeholder="Product Name.." 
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="category" id="category" class="form-control" >
                                        ...
                                        @forelse ($categories as $categorie)
                                            ...
                                            <option value="{{ $categorie->id }}" id="category_name">{{ $categorie->categoy_name }}</option>
                                        @empty
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('video_url') }}" placeholder="Video Url..."
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="number" min="1" value="{{ old('selling_price') }}" class="form-control"  placeholder="Selling Price..."
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" min="1" class="form-control" value="{{ old('discount_price') }}"  placeholder="Discount Price..."
                    ...
                    <div class="panel panel-bd lobidrag panel-primary">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="thumbnail_input_content">
                                <label for="product_thumbnail">Main Thumbnail<span class="text-danger">*</span></label>
                            ...
                            <div>
                                <label for="" class="product_image_text_title">Click Plus Button For More
                                    Images</label>
                                ...
                                <div class="switch_content">
                                    <div>
                                        <div>
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" value="1" name="top_review">
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" value="1" name="best_sell">
                                                <span class="slider"></span>
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="switch_content">
                                    <div>
                                        <div>
                                            ...
                                            <label class="switch">
                                                <input type="checkbox" checked value="1" name="exclusive_template">
                                                <span class="slider"></span>
                                            </label>
                                        </div>
                                    </div>
