...
@section('admin_main_content')
    <section class="content-header">
        ...
        <div class="header-title">
            <h1> Edit Coupon</h1>
            <small>Edit Coupon Features</small>
                            ...
                            <form action="{{ route('coupon.update',$coupon->id) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="coupon_name" value="{{ $coupon->coupon_name }}" id="coupon_name" required class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="coupon_code" value="{{ $coupon->coupon_code }}" id="coupon_code" required class="form-control"
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="start_date" value="{{ \Carbon\Carbon::parse($coupon->start_date)->format('Y-m-d') }}" id="start_date" required class="form-control">
                                        @error('start_date')
                                            <p class="text-danger error_text">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" name="end_date" id="end_date" value="{{ \Carbon\Carbon::parse($coupon->end_date)->format('Y-m-d') }}" required class="form-control">
                                        @error('end_date')
                                            <p class="text-danger error_text">{{ $message }}</p>
                                        @enderror
                                    </div>
